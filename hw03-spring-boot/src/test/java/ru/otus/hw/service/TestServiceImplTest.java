...
public class TestServiceImplTest {
    ...
    void checkProcessingOfQuestions() {
        var answerTemplate = TestServiceImpl.PRINT_ANSWER_FORMAT_TEMPLATE;
        ...
        verify(ioService).printFormattedLineLocalized("TestService.question.format.template", expectedQuestionsArgs);
